...
const games = [
  ...
  { id: 'dodge-ball', title: 'Dodge Ball', description: 'Dodge falling balls as long as you can!', image: 'https://images.unsplash.com/photo-1461896836934- voices?w=400&h=300&fit=crop', category: 'Arcade', rating: 4.5, players: '10.2K', color: 'hsl(270, 100%, 60%)' },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative pt-24 pb-16 px-4 overflow-hidden">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-2xl mx-auto mt-16">
            {[{ value: '50K+', label: 'Players' }, { value: '32', label: 'Games' }, { value: '$10K', label: 'In Rewards' }].map(({ value, label }) => (
      ...
      <section className="py-16 px-4 bg-card/50">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Trophy, title: 'Compete & Win', description: 'Climb the leaderboards and prove you\'re the best!', color: 'text-warning' },
              { icon: Gift, title: 'Daily Rewards', description: 'Log in every day to claim free coins and gems!', color: 'text-success' },
              { icon: Zap, title: 'Instant Play', description: 'No downloads! Play directly in your browser.', color: 'text-primary' }
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto text-center">
          ...
          <p className="text-sm text-muted-foreground">© 2025 Glitch Games. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
