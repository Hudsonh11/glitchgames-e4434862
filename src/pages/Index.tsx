...
const games = [{
  ...
  image: 'https://images.unsplash.com/photo-1461896836934-adb67007e0cd?w=400&h=300&fit=crop',
  category: 'Arcade',
  rating: 4.5,
  players: '10.2K',
...
const Index: React.FC = () => {
  ...
  return <div className="min-h-screen bg-background relative">
      ...
      {/* Maintenance Banner */}
      {gamesShutdown && <div className="bg-destructive/20 border-y border-destructive/30 py-4 px-4 backdrop-blur-sm">
      ...
      <section id="games" className="py-20 px-4 relative">
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {games.map((game, index) => <div key={game.id} className="animate-fade-in-up" style={{
